...
public:
     ...
     * `path_encoding` uses the integer node IDs of `graph`;
     * @param buffer temporary space.
     */
...
private:
     ...
     * when an INS occurs between two adjacent INVs). And there might be no walk that traverses such edges. This is not
     * wrong in general.
     *
