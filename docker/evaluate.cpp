...
void evaluate(
    ...
    for (size_t i=0; i<=regions.size()/fetch_regions_quantum; i++) {
        vector<Region> regions_prime(regions.begin()+i*fetch_regions_quantum,regions.begin()+min((i+1)*fetch_regions_quantum,regions.size()));
...
int main (int argc, char* argv[]){
    ...
    size_t fetch_regions_quantum = 10000;
    bool debug = false;
